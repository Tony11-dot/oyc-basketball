...
const SECTIONS: LegalSection[] = [
  {
    ...
    body: [
      {
        ar: "هذه السياسة تخصّ موقع النادي الأرثوذكسي لكرة السلة – الناصرة (نادي الروم لكرة السلة)، وتشرح كيف نجمع بياناتكم الشخصية عبر الموقع، ولماذا، وكيف نحميها.",
        he: "מדיניות זו נוגעת לאתר של האגודה האורתודוקסית לכדורסל – נצרת (נדי אלרום לכדורסל), ומסבירה כיצד אנו אוספים את המידע האישי שלכם באתר, לשם מה, וכיצד אנו שומרים עליו.",
