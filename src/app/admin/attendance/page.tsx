...
export default function AttendanceAdmin() {
  ...
  const L = {
    ...
    sessions: pick({ ar: "التمارين", he: "אימונים", en: "Practices" }),
    ...
    perSession: pick({ ar: "لكل تمرين", he: "לאימון", en: "per practice" }),
    ...
    bestDay: pick({ ar: "أفضل تمرين", he: "האימון הטוב", en: "Best practice" }),
