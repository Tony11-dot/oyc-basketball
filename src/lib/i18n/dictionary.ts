...
export const dictionaries: Record<Locale, Dict> = {
  ar: {
    ...
    admin: {
      ...
      registerEditor: { eyebrow: "تمهيد", heading: "العنوان", subheading: "العنوان الفرعي", feeNote: "ملاحظة الرسوم", consent: "نص الإقرار", perks: "المزايا", addPerk: "إضافة ميزة", feeAmount: "قيمة الرسوم (₪)", feeAmountHint: "الرسم الافتراضي للاعب — يُستخدم في الدفع بالبطاقة وفي كل مكان آخر (اللاعبين، الفرق، الوصول)" },
  ...
  he: {
    ...
    admin: {
      ...
      registerEditor: { eyebrow: "תווית", heading: "כותרת", subheading: "כותרת משנה", feeNote: "הערת תשלום", consent: "טקסט הסכמה", perks: "יתרונות", addPerk: "הוספת יתרון", feeAmount: "סכום התשלום (₪)", feeAmountHint: "דמי הרישום המוגדרים כברירת מחדל — משמשים לתשלום בכרטיס וגם בכל מקום אחר (שחקנים, קבוצות, קבלות)" },
  ...
  en: {
    ...
    admin: {
      ...
      registerEditor: { eyebrow: "Eyebrow", heading: "Heading", subheading: "Subheading", feeNote: "Fee note", consent: "Consent text", perks: "Perks", addPerk: "Add perk", feeAmount: "Fee amount (₪)", feeAmountHint: "the club's default fee — drives the card charge and every other price shown (players, teams, receipts)" },
